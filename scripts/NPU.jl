...
function test_eval()
    ...
    h1 = histogram(map(i->minimum(abs.(DFt[i,:p])),findall(in1)),nbins=100)
    h2 = histogram(map(i->minimum(abs.(DFt[i,:p])),findall(in2)),nbins=100)
    h1v = histogram(map(i->minimum(abs.(DFv[i,:p])),findall(in1v)),nbins=100)
    h2v = histogram(map(i->minimum(abs.(DFv[i,:p])),findall(in2v)),nbins=100)
